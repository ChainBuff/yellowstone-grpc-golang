...
// NewInitializeInstructionBuilderExt creates a new `Initialize` instruction builder.
func NewInitializeInstructionBuilderExt(remainingAccounts int) *Initialize {
	nd := &Initialize{
		AccountMetaSlice: make(ag_solanago.AccountMetaSlice, 3+remainingAccounts),
	}
	nd.AccountMetaSlice[2] = ag_solanago.Meta(Addresses["11111111111111111111111111111111"])
	return nd
}
...
func (inst *Initialize) AddRemainingAccounts(remainingAccounts []ag_solanago.PublicKey) *Initialize {
	accounts := 3
