...
// NewUpdateGlobalAuthorityInstructionBuilderExt creates a new `UpdateGlobalAuthority` instruction builder.
func NewUpdateGlobalAuthorityInstructionBuilderExt(remainingAccounts int) *UpdateGlobalAuthority {
	nd := &UpdateGlobalAuthority{
...
func (inst *UpdateGlobalAuthority) findFindGlobalAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *UpdateGlobalAuthority) FindGlobalAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindGlobalAddress(bumpSeed)
	return
}

func (inst *UpdateGlobalAuthority) MustFindGlobalAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindGlobalAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *UpdateGlobalAuthority) FindGlobalAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindGlobalAddress(0)
	return
}

func (inst *UpdateGlobalAuthority) MustFindGlobalAddress() (pda ag_solanago.PublicKey) {
...
func (inst *UpdateGlobalAuthority) findFindEventAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *UpdateGlobalAuthority) FindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindEventAuthorityAddress(bumpSeed)
	return
}

func (inst *UpdateGlobalAuthority) MustFindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindEventAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *UpdateGlobalAuthority) FindEventAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindEventAuthorityAddress(0)
	return
}

func (inst *UpdateGlobalAuthority) MustFindEventAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *UpdateGlobalAuthority) AddRemainingAccounts(remainingAccounts []ag_solanago.PublicKey) *UpdateGlobalAuthority {
	accounts := 5
...
func NewUpdateGlobalAuthorityInstruction(
	...
	program ag_solanago.PublicKey) *UpdateGlobalAuthority {
